...
class DecoderBlock():
    ...
    def forward(self, target, source, training=True):
        q, k, v = target, target, target
        attention_output1 = self.multi_head_att1.forward(q, k, v, training)
        ...
        attention_output2 = self.multi_head_att2.forward(q, k, v, training)
