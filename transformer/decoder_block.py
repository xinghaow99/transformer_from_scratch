...
class DecoderBlock():
    def __init__(self, optimizer, d_model=512, d_ff=2048, num_attention_heads=8, dropout_rate=0.1, data_type=cp.float32):
    ...
    def forward(self, target, source, target_mask, src_tgt_mask, training=True):
        # print('target_mask shape: ', target_mask[0].shape)
        ...
        # print('src_tgt_mask shape: ', src_tgt_mask[0].shape)
